  ...
  public: {
    Tables: {
      box_configurations: {
        ...
        Relationships: [
          {
            foreignKeyName: "box_configurations_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: true
      ...
      production_batches: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "production_batches_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: false
            referencedRelation: "product_variants"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "manager" | "staff" | "pending" | "customer"
    }
    CompositeTypes: {
      [_ in never]: never
    }
