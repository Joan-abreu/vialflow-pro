        ...
        <div className={`rounded-2xl border border-border/80 bg-card overflow-hidden shadow-xs divide-y divide-border/60 ${className}`}>
            ...
            <div className="p-3.5 sm:p-4 flex items-start gap-3">
                ...
                <div className="space-y-0.5 min-w-0">
                    ...
                    <p className="text-[11px] sm:text-xs text-muted-foreground">
                        Standard carrier ground delivery
                    </p>
                </div>
            </div>
                ...
                {config.acceptedPaymentMethods && config.acceptedPaymentMethods.length > 0 && (
                    <div className="flex items-center flex-wrap gap-2 pt-1">
                        ...
                        {config.acceptedPaymentMethods.includes("visa") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="Visa">
                                <svg className="h-3.5 w-auto fill-[#1A1F71] dark:fill-white" viewBox="0 0 39 13.5" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {config.acceptedPaymentMethods.includes("mastercard") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="Mastercard">
                                <svg className="h-4.5 w-auto" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="9.5" cy="10" r="7.5" fill="#EB001B"/>
                                    <circle cx="20.5" cy="10" r="7.5" fill="#F79E1B"/>
                                    <path d="M15 4.87a7.48 7.48 0 0 0-2.8 5.13c0 2.05 1.1 3.9 2.8 5.13a7.48 7.48 0 0 0 2.8-5.13 7.48 7.48 0 0 0-2.8-5.13z" fill="#FF5F00"/>
                                </svg>
                            </div>
                        )}
                        ...
                        {config.acceptedPaymentMethods.includes("amex") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="American Express">
                                <span className="text-[10px] font-black tracking-tight text-[#006FCF] dark:text-[#3894E6]">AMEX</span>
                            </div>
                        )}

                        {/* Discover */}
                        {config.acceptedPaymentMethods.includes("discover") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="Discover">
                                <div className="flex items-center text-[9.5px] font-black tracking-tight text-[#1A1F71] dark:text-white">
                                    <span>DISC</span>
                                    <span className="h-1.5 w-1.5 rounded-full bg-[#FF6000] inline-block mx-[0.5px]"></span>
                                    <span>VER</span>
                                </div>
                            </div>
                        )}
                        ...
                        {config.acceptedPaymentMethods.includes("apple_pay") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="Apple Pay">
                                <svg className="h-4 w-auto fill-foreground" viewBox="0 0 39 21" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {config.acceptedPaymentMethods.includes("google_pay") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="Google Pay">
                                <svg className="h-3.5 w-auto" viewBox="0 0 42 18" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {config.acceptedPaymentMethods.includes("zelle") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center gap-1 shadow-2xs" title="Zelle">
                        ...
                        {config.acceptedPaymentMethods.includes("cashapp") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center gap-1 shadow-2xs" title="Cash App">
                                <span className="text-[11px] font-black text-[#00D632] leading-none">$</span>
                                <span className="text-[9.5px] font-bold text-foreground tracking-tight">Cash App</span>
                            </div>
                        )}

                        {/* Venmo */}
                        {config.acceptedPaymentMethods.includes("venmo") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center shadow-2xs" title="Venmo">
                                <span className="text-[10.5px] font-black text-[#008CFF] dark:text-[#38BDF8] italic tracking-tight">venmo</span>
                            </div>
                        )}

                        {/* Bitcoin / Crypto */}
                        {config.acceptedPaymentMethods.includes("crypto") && (
                            <div className="h-7.5 min-w-[46px] px-2.5 bg-background border border-border/80 rounded-md flex items-center justify-center gap-1 shadow-2xs" title="Crypto / Bitcoin">
                                <span className="text-[11px] font-black text-[#F7931A] leading-none">₿</span>
                                <span className="text-[9.5px] font-bold text-foreground tracking-tight">Crypto</span>
                            </div>
                        )}
                    </div>
                )}
